...
out <- filterAndTrim(fwd = fnFs, filt = filtFs, rev = fnRs, filt.rev = filtRs, truncLen=c(145,145), truncQ=2, rm.phix=TRUE, compress=TRUE, multithread=CORES) # On Windows set multithread=FALSE
